...
- **Refactor while green.** After the smallest implementation passes, improve names, duplication
  and structure without changing behaviour. Re-run the focused test after each refactor. A change
  that needs a new behaviour belongs in the next red cycle; a broad architectural redesign belongs
